...
namespace CommercialBankLibrary_16
{
    ...
    public class Customer : INotifyPropertyChanged
    {
        ...
        public static void RandomCustomer(User user = null)
        {
            new Customer(
                RandomCustomerDetails.GetRandomName(),
                RandomCustomerDetails.GetRandomName(),
                RandomCustomerDetails.GetRandomName(),
                RandomCustomerDetails.GetRandomPhoneNumber(),
                RandomCustomerDetails.GetRandomPassportNumber(),
                RandomCustomerDetails.GetRandomPassportSerries(),
                user);
        }
    ...
    public static class RandomCustomerDetails
    {
        ...
        {
            return (1160000 + random.Next(0, 10000)).ToString();
        }

        public static string GetRandomPhoneNumber()
        {
            return "555-" + random.Next(0, 100000).ToString();
        }

        public static string GetRandomPassportSerries()
        {
